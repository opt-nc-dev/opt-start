package nc.opt.core.poc.app.repository;

import nc.opt.core.poc.app.config.ConditionalOnJpaEnable;
import nc.opt.core.poc.app.config.ConditionalOnOPTJpa;
import nc.opt.core.poc.app.config.Constants;
import nc.opt.core.poc.app.config.audit.AuditEventConverter;
import nc.opt.core.poc.app.domain.PersistentAuditEvent;
